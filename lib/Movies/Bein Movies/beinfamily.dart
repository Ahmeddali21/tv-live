...
class beinfamily extends StatefulWidget {
  const beinfamily({Key? key}) : super(key: key);

  @override
  State<beinfamily> createState() => _beinfamilyState();
}

class _beinfamilyState extends State<beinfamily> {
      ...
      builder: (context, snapshot) {
        return CupertinoPageScaffold(
            navigationBar: CupertinoNavigationBar(
              middle: Text("Bein Movies Family"),
            ),
