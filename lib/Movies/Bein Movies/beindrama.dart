...
class beindrama extends StatefulWidget {
  const beindrama({Key? key}) : super(key: key);

  @override
  State<beindrama> createState() => _beindramaState();
}

class _beindramaState extends State<beindrama> {
