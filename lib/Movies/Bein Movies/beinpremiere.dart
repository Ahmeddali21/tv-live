...
class beinpremiere extends StatefulWidget {
  const beinpremiere({Key? key}) : super(key: key);

  @override
  State<beinpremiere> createState() => _beinpremiereState();
}

class _beinpremiereState extends State<beinpremiere> {
      ...
      builder: (context, snapshot) {
        return CupertinoPageScaffold(
            navigationBar: CupertinoNavigationBar(
              middle: Text("Bein Movies Premiere"),
            ),
