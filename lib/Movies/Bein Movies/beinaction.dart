...
class beinaction extends StatefulWidget {
  const beinaction({Key? key}) : super(key: key);

  @override
  State<beinaction> createState() => _beinactionState();
}

class _beinactionState extends State<beinaction> {
      ...
      builder: (context, snapshot) {
        return CupertinoPageScaffold(
            navigationBar: const CupertinoNavigationBar(
              middle: Text("Bein Movies Action"),
            ),
