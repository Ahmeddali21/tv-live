...
class mbc2 extends StatefulWidget {
  const mbc2({Key? key}) : super(key: key);

  @override
  State<mbc2> createState() => _mbc2State();
}

class _mbc2State extends State<mbc2> {
  ...
  DocumentReference url =
      FirebaseFirestore.instance.collection("movies").doc("mbc2");
  getdata() async {
