...
class foxcrime extends StatefulWidget {
  const foxcrime({Key? key}) : super(key: key);

  @override
  State<foxcrime> createState() => _foxcrimeState();
}

class _foxcrimeState extends State<foxcrime> {
