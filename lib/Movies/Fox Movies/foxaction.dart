...
class foxaction extends StatefulWidget {
  const foxaction({Key? key}) : super(key: key);

  @override
  State<foxaction> createState() => _foxactionState();
}

class _foxactionState extends State<foxaction> {
