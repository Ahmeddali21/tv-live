...
class artaflam1 extends StatefulWidget {
  const artaflam1({Key? key}) : super(key: key);

  @override
  State<artaflam1> createState() => _artaflam1State();
}

class _artaflam1State extends State<artaflam1> {
