...
class osnpremiere extends StatefulWidget {
  const osnpremiere({Key? key}) : super(key: key);

  @override
  State<osnpremiere> createState() => _osnpremiereState();
}

class _osnpremiereState extends State<osnpremiere> {
      ...
      builder: (context, snapshot) {
        return CupertinoPageScaffold(
            navigationBar: const CupertinoNavigationBar(
              middle: Text("OSN Movies Premiere"),
            ),
