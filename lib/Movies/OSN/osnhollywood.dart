...
class osnhollywood extends StatefulWidget {
  const osnhollywood({Key? key}) : super(key: key);

  @override
  State<osnhollywood> createState() => _osnhollywoodState();
}

class _osnhollywoodState extends State<osnhollywood> {
      ...
      builder: (context, snapshot) {
        return CupertinoPageScaffold(
            navigationBar: const CupertinoNavigationBar(
              middle: Text("OSN Movies Hollywood"),
            ),
