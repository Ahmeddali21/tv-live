...
class osncomedy extends StatefulWidget {
  const osncomedy({Key? key}) : super(key: key);

  @override
  State<osncomedy> createState() => _osncomedyState();
}

class _osncomedyState extends State<osncomedy> {
