...
class adsportpremium1 extends StatefulWidget {
  const adsportpremium1({Key? key}) : super(key: key);

  @override
  State<adsportpremium1> createState() => _adsportpremium1State();
}

class _adsportpremium1State extends State<adsportpremium1> {
      ...
      builder: (context, snapshot) {
        return CupertinoPageScaffold(
            navigationBar: const CupertinoNavigationBar(
              middle: Text("AD Sports Premium 1"),
            ),
