...
class beinsportpremium2 extends StatefulWidget {
  const beinsportpremium2({Key? key}) : super(key: key);

  @override
  State<beinsportpremium2> createState() => _beinsportpremium2State();
}

class _beinsportpremium2State extends State<beinsportpremium2> {
      ...
      builder: (context, snapshot) {
        return CupertinoPageScaffold(
            navigationBar: const CupertinoNavigationBar(
              middle: Text("Bein Sports Premium 2"),
            ),
