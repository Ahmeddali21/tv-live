...
class beinsportpremium3 extends StatefulWidget {
  const beinsportpremium3({Key? key}) : super(key: key);

  @override
  State<beinsportpremium3> createState() => _beinsportpremium3State();
}

class _beinsportpremium3State extends State<beinsportpremium3> {
      ...
      builder: (context, snapshot) {
        return CupertinoPageScaffold(
            navigationBar: const CupertinoNavigationBar(
              middle: Text("Bein Sports Premium 3"),
            ),
