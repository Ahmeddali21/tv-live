...
class beinsportpremium1 extends StatefulWidget {
  const beinsportpremium1({Key? key}) : super(key: key);

  @override
  State<beinsportpremium1> createState() => _beinsportpremium1State();
}

class _beinsportpremium1State extends State<beinsportpremium1> {
      ...
      builder: (context, snapshot) {
        return CupertinoPageScaffold(
            navigationBar: const CupertinoNavigationBar(
              middle: Text("Bein Sports Premium 1"),
            ),
