...
class alarabia extends StatefulWidget {
  const alarabia({Key? key}) : super(key: key);

  @override
  State<alarabia> createState() => _alarabiaState();
}

class _alarabiaState extends State<alarabia> {
  ...
  DocumentReference url =
      FirebaseFirestore.instance.collection("news").doc("alarbiya");
  getdata() async {
