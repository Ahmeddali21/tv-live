...
class alhadath extends StatefulWidget {
  const alhadath({Key? key}) : super(key: key);

  @override
  State<alhadath> createState() => _alhadathState();
}

class _alhadathState extends State<alhadath> {
  ...
  DocumentReference url =
      FirebaseFirestore.instance.collection("news").doc("alhadath");
  getdata() async {
