...
class dw extends StatefulWidget {
  const dw({Key? key}) : super(key: key);

  @override
  State<dw> createState() => _dwState();
}

class _dwState extends State<dw> {
  ...
  DocumentReference url =
      FirebaseFirestore.instance.collection("news").doc("dw");
  getdata() async {
