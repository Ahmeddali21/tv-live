...
class cnbc extends StatefulWidget {
  const cnbc({Key? key}) : super(key: key);

  @override
  State<cnbc> createState() => _cnbcState();
}

class _cnbcState extends State<cnbc> {
  ...
  DocumentReference url =
      FirebaseFirestore.instance.collection("news").doc("cnbc");
  getdata() async {
