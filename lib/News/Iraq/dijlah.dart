...
class dijlah extends StatefulWidget {
  const dijlah({Key? key}) : super(key: key);

  @override
  State<dijlah> createState() => _dijlahState();
}

class _dijlahState extends State<dijlah> {
  ...
  DocumentReference url =
      FirebaseFirestore.instance.collection("news").doc("dijlah");
  getdata() async {
