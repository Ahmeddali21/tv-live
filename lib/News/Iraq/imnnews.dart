...
class imnnews extends StatefulWidget {
  const imnnews({Key? key}) : super(key: key);

  @override
  State<imnnews> createState() => _imnnewsState();
}

class _imnnewsState extends State<imnnews> {
  ...
  DocumentReference url =
      FirebaseFirestore.instance.collection("news").doc("imnnews");
  getdata() async {
