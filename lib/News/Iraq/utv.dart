...
class utv extends StatefulWidget {
  const utv({Key? key}) : super(key: key);

  @override
  State<utv> createState() => _utvState();
}

class _utvState extends State<utv> {
  ...
  DocumentReference url =
      FirebaseFirestore.instance.collection("news").doc("utv");
  getdata() async {
