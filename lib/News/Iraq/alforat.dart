...
class alforat extends StatefulWidget {
  const alforat({Key? key}) : super(key: key);

  @override
  State<alforat> createState() => _alforatState();
}

class _alforatState extends State<alforat> {
  ...
  DocumentReference url =
      FirebaseFirestore.instance.collection("news").doc("alforat");
  getdata() async {
