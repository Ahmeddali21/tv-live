...
class aliraqia extends StatefulWidget {
  const aliraqia({Key? key}) : super(key: key);

  @override
  State<aliraqia> createState() => _aliraqiaState();
}

class _aliraqiaState extends State<aliraqia> {
  ...
  DocumentReference url =
      FirebaseFirestore.instance.collection("news").doc("aliraqia");
  getdata() async {
