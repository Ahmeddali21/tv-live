...
class mbcmasr1 extends StatefulWidget {
  const mbcmasr1({Key? key}) : super(key: key);

  @override
  State<mbcmasr1> createState() => _mbcmasr1State();
}

class _mbcmasr1State extends State<mbcmasr1> {
