...
class mbcdrama2 extends StatefulWidget {
  const mbcdrama2({Key? key}) : super(key: key);

  @override
  State<mbcdrama2> createState() => _mbcdrama2State();
}

class _mbcdrama2State extends State<mbcdrama2> {
