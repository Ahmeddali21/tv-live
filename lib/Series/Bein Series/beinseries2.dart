...
class beinseries2 extends StatefulWidget {
  const beinseries2({Key? key}) : super(key: key);

  @override
  State<beinseries2> createState() => _beinseries2State();
}

class _beinseries2State extends State<beinseries2> {
