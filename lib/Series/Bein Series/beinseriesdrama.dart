...
class beinseriesdrama extends StatefulWidget {
  const beinseriesdrama({Key? key}) : super(key: key);

  @override
  State<beinseriesdrama> createState() => _beinseriesdramaState();
}

class _beinseriesdramaState extends State<beinseriesdrama> {
