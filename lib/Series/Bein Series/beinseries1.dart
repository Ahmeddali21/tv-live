...
class beinseries1 extends StatefulWidget {
  const beinseries1({Key? key}) : super(key: key);

  @override
  State<beinseries1> createState() => _beinseries1State();
}

class _beinseries1State extends State<beinseries1> {
