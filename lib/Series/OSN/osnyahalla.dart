...
class osnyahalla extends StatefulWidget {
  const osnyahalla({Key? key}) : super(key: key);

  @override
  State<osnyahalla> createState() => _osnyahallaState();
}

class _osnyahallaState extends State<osnyahalla> {
