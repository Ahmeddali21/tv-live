...
class osnalfasafwa extends StatefulWidget {
  const osnalfasafwa({Key? key}) : super(key: key);

  @override
  State<osnalfasafwa> createState() => _osnalfasafwaState();
}

class _osnalfasafwaState extends State<osnalfasafwa> {
      ...
      builder: (context, snapshot) {
        return CupertinoPageScaffold(
            navigationBar: const CupertinoNavigationBar(
              middle: Text("OSN Series Alfa Safwa"),
            ),
