...
class osnshowcase extends StatefulWidget {
  const osnshowcase({Key? key}) : super(key: key);

  @override
  State<osnshowcase> createState() => _osnshowcaseState();
}

class _osnshowcaseState extends State<osnshowcase> {
      ...
      builder: (context, snapshot) {
        return CupertinoPageScaffold(
            navigationBar: const CupertinoNavigationBar(
              middle: Text("OSN Series Showcase"),
            ),
