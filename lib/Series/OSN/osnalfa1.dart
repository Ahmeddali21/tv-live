...
class osnalfa1 extends StatefulWidget {
  const osnalfa1({Key? key}) : super(key: key);

  @override
  State<osnalfa1> createState() => _osnalfa1State();
}

class _osnalfa1State extends State<osnalfa1> {
