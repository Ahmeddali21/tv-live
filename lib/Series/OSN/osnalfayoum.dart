...
class osnalfayoum extends StatefulWidget {
  const osnalfayoum({Key? key}) : super(key: key);

  @override
  State<osnalfayoum> createState() => _osnalfayoumState();
}

class _osnalfayoumState extends State<osnalfayoum> {
      ...
      builder: (context, snapshot) {
        return CupertinoPageScaffold(
            navigationBar: const CupertinoNavigationBar(
              middle: Text("OSN Series Alfa Youm"),
            ),
