...
class osnalfa2 extends StatefulWidget {
  const osnalfa2({Key? key}) : super(key: key);

  @override
  State<osnalfa2> createState() => _osnalfa2State();
}

class _osnalfa2State extends State<osnalfa2> {
