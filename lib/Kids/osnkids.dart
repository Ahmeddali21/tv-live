...
class osnkids extends StatefulWidget {
  const osnkids({Key? key}) : super(key: key);

  @override
  State<osnkids> createState() => _osnkidsState();
}

class _osnkidsState extends State<osnkids> {
